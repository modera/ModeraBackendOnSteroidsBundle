...
/**
 * Same as in PathExpressionResolver but, in case 'excluded_namespaces' parameter is present all bundles name fill be
 ...
 */
class PathExpressionWithExcludeResolver
{
    /**
     * @var KernelInterface
     */
