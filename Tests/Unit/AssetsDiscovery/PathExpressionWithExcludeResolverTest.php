...
use Modera\BackendOnSteroidsBundle\AssetsDiscovery\PathExpressionWithExcludeResolver;
 ...
 */
class PathExpressionResolverWithExcludeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResolve()
    {
        ...
        $resolver = new PathExpressionWithExcludeResolver($kernel);
